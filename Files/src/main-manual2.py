...
number_of_repetitions, evaluation, save_results, env, task_short, dim_a, mountaincar_env, metaworld_env, feedback_joystick
...
for i_episode in range(max_num_of_episodes):
    ...
    for t in range(int(max_time_steps_episode + 1)):
        ...
        #evaluation = feedback_joystick.evaluation
        ...
        print('Episode: ', i_episode, "t this ep: ", t, ' total timesteps: ', t_total, 'time: ', time_plot, ' h: ', h)
