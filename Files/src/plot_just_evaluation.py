...
tests_Evaluation = [testHM_ev3_1_500, testHM_ev3_0_1_500, testHM_ev3_0_01_500, testNOHM_ev3_1_500, testNOHM_ev3_0_1_500, testNOHM_ev3_0_01_500, testHM_ev_1, testHM_ev_0_1, testHM_ev_0_01, testNOHM_ev_1, testNOHM_ev_0_1, testNOHM_ev_0_01]
...
for test_ev in tests_Evaluation:
    ...
    if human_model == "yes" and e == 0.1 and buffer_size == 15000:
        colorPlot = '#2978B5'  # green
        linestyle = 'solid'
    if human_model == "yes" and e == 1 and buffer_size == 15000:
        colorPlot = '#8AB6D6'  # violet
        linestyle = 'solid'
    ...
    if human_model == "no" and e == 0.1 and buffer_size == 15000:
        colorPlot = '#FF6B6B'  # red
        linestyle = 'solid'
    if human_model == "no" and e == 1 and buffer_size == 15000:
        colorPlot = '#FDD2BF'  # brown
        linestyle = 'solid'
    ...
    #axs.plot(simulated_time, return_mean, linewidth=0.1, zorder=0, color=colorPlot)
    axs.plot(simulated_time, p(simulated_time), linewidth=2.0, linestyle=linestyle, color=colorPlot, zorder=1, label='H: ' + human_model + ', Buffer size: ' + str(buffer_size) + ', e: ' + str(e))
    #axs.fill_between(minutes_list, return_mean - return_std, return_mean + return_std, alpha=0.02, color=colorPlot)
    ...
    axs.set_title('Evaluation of task: Meta-World hockey')
